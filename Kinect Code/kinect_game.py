        ...
        while not self._done:
            ...
            if self._kinect.has_new_color_frame():
                ...
                if self.isRecording:
                    ...
                    self._timestamps[0].append([self._video_frameno[0],str(datetime.now().time())])
            ...
            if self._kinect.has_new_depth_frame() and self.isRecording:
                ...
                #frame1 = ((frame1 >> 3) & 4095)
                #cv2.imshow('frame1', frame1)
                #cv2.waitKey(5)
                self._video_frameno[1] += 1
                self._timestamps[1].append([self._video_frameno[1], str(datetime.now().time())])
